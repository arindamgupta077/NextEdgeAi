    ...
    <section id="portfolio" ref={sectionRef} className="relative section-padding overflow-hidden">
      ...
      <div className="container-narrow relative z-10">
          ...
          <AnimatePresence>
            {visible.map((project) => (
              <motion.div
                ...
                className={`portfolio-card group relative rounded-2xl overflow-hidden cursor-pointer border border-white/6
        ...
        <div className="mt-14 text-center">
          <a href="/portfolio" className="cursor-none group inline-flex items-center gap-2 px-7 py-3.5 rounded-full border border-white/15 text-gray-300 hover:text-white hover:border-white/30 transition-all text-sm">
            View Full Portfolio
